...
const categories: Category[] = [
  {
    ...
    items: [
      ...
      { name: 'Curry-Mango', emoji: '🥭', gradient: 'linear-gradient(135deg,#f59e0b,#b45309)', desc: 'Curry suave con puré de mango. Dulce, exótica y aromática. El secreto del Taco Tropical.', origin: 'Fusión', img: '/img/salsas/processed/curry.png' },
